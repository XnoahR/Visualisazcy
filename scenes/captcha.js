...
export const captchaShort = scene({
  id: 'captcha_short',
  kind: 'trace',
  title: 'Not a robot — 9 second cut',
  caption: 'The same traces and the same numbers, paced for a reel instead of a lesson.',
  watermark: 'Visualizcy',
  lanes: captcha.lanes,
  steps: [
    {
      label: 'You reach for it',
      note: 'A hand arcs, wobbles, and slows down as it arrives.',
      duration: 3200,
      lanes: ['human'],
      trace: 'play',
    },
    {
      label: 'A script does not',
      note: 'It sets the coordinate and goes. Straight, even, far too fast.',
      duration: 3000,
      lanes: ['human', 'bot'],
      trace: 'play',
    },
    {
      label: 'The path is the tell',
      note: 'Measured off the traces. Nothing here asked you a question.',
      duration: 3300,
      lanes: ['human', 'bot'],
      trace: 1,
